...
import "../node_modules/d2l-offscreen/d2l-offscreen.js";
...
import "../node_modules/d2l-progress/d2l-progress.js";
import "../node_modules/@brightspace-ui/core/components/icons/icon.js";
import { isColorAccessible } from "../node_modules/@brightspace-ui/core/helpers/contrast.js";
...
`;
  ...
  _lightenMeter() {
    ...
    this._lightMeter = opacity >= 1 && this.currentActivity === this._selfLink && bkgdColour !== 'transparent' && !isColorAccessible(bkgdColour, ferrite);
  }
  ...
  _getCompletionProgress(properties) {
    return properties && properties.completionProgressLangTerm || this._self && this._self.localize('sequenceNavigator.currentModule', 'current', this._moduleIndex, 'total', this._siblingModules) || '';
  }
