...
import "../node_modules/d2l-navigation/d2l-navigation-button-notification-icon.js";
...
export class D2LSequencesIterator extends mixinBehaviors([D2L.PolymerBehaviors.Siren.EntityBehavior, D2L.PolymerBehaviors.Sequences.LocalizeBehavior], PolymerElement) {
  static get template() {
    return html`
		<style>
...
`;
  ...
  static get observers() {
    return ['_setLink(entity)', '_setDisabled(href)'];
  }
