...
import { D2LSequencesContentVideo } from "./d2l-sequences-content-video.js";
import { D2LSequencesContentAudio } from "./d2l-sequences-content-audio.js";
import './d2l-sequences-content-file-html.js';
import { D2LSequencesContentLinkMixed } from './d2l-sequences-content-link-mixed.js';
import { D2LSequencesContentLinkNewTab } from "./d2l-sequences-content-link-new-tab.js";
...
class D2LSequencesContentRouter extends D2L.Polymer.Mixins.Sequences.RouterMixin(getEntityType) {
  ...
  static get mimeType() {
    return new Map([['application/pdf', D2LSequencesContentFilePdf.is], ['video/mp4', D2LSequencesContentVideo.is], ['video/ogg', D2LSequencesContentVideo.is], ['video/webm', D2LSequencesContentVideo.is], ['audio/webm', D2LSequencesContentVideo.is], ['audio/flac', D2LSequencesContentAudio.is], ['audio/mp3', D2LSequencesContentAudio.is], ['audio/ogg', D2LSequencesContentAudio.is], ['audio/aac', D2LSequencesContentAudio.is], ['audio/wave', D2LSequencesContentAudio.is], ['image/bmp', D2LSequencesContentFileHtml.is], ['image/gif', D2LSequencesContentFileHtml.is], ['image/jpeg', D2LSequencesContentFileHtml.is], ['image/png', D2LSequencesContentFileHtml.is], ['image/svg+xml', D2LSequencesContentFileHtml.is], ['text/html', D2LSequencesContentFileHtml.is]]);
  }
...
function getEntityType(entity) {
  ...
  for (let i = 0; i < entity.entities.length; i++) {
    const subEntity = entity.entities[i]; // hypermedia classes tend to be more specific at the end of the array
