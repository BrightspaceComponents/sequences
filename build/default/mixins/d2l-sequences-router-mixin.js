...
import { TemplateStamp } from "../node_modules/@polymer/polymer/lib/mixins/template-stamp.js";
import { mixinBehaviors } from "../node_modules/@polymer/polymer/lib/legacy/class.js";
import { PolymerElement } from "../node_modules/@polymer/polymer/polymer-element.js";

function RouterMixin(getEntityType) {
  return class extends TemplateStamp(mixinBehaviors([D2L.PolymerBehaviors.Siren.EntityBehavior], PolymerElement)) {
    ...
    connectedCallback() {
      ...
      this._hrefUpdated = this.addEventListener('hrefUpdated', ({
        detail
      }) => {
    ...
    _render(entity, error) {
      ...
      this._debouncer = Debouncer.debounce(this._debouncer, timeOut.after(20), () => {
        const entityType = error ? D2LSequencesContentError.is : getEntityType(entity);
        const replaceContentElement = entity && (!this._contentElement || this._contentElement.href !== this.href) || error;
